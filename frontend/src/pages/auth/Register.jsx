        ...
        <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-sm relative animate-fade-up">
                ...
                <div className="card space-y-5">
                    <div>
                        <h1 className="font-display font-bold text-lg text-zinc-100">Create account</h1>
                        <p className="text-xs text-zinc-500 mt-0.5">Start your analytics journey</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-zinc-600 mt-1">Alphanumeric, min 3 chars</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-600 mt-1">Min 8 characters</p>
                        </div>
